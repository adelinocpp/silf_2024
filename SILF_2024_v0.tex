...
\begin{frame}[fragile=singleslide]
	...
	\end{enumerate}
	\vspace{0.5cm}
	\textbf{Hipótese:} GLM permite remover parte da informação do sinal acústico -- como o contexto fonológico --, e com isso acentuar as demais informações, como a identidade do locutor. \\
	\vspace{0.5cm}
	\textbf{Restrição:} Os autores optaram por utilizar uma modelagem estatística baseada em variáveis pragmáticas (no espaço mensurável), buscando transparência do modelo.
\end{frame}
% ==============================================================================
...
\begin{frame}[fragile=singleslide]
	...
	\begin{itemize}[]
		...
		\item 5615 unidades amostrais (vogais ou ditongos);
		\item entre 143 e 512 unidades por locutor;
		\item rotulagem manual com revisão;
		\item processamento em python  \textit{scipy}, \textit{scikit-learn}, \textit{pandas} e \textit{matplotlib};
	\end{itemize}

	\begin{tikzpicture}[remember picture,overlay]
		\node[xshift=-4.0cm,yshift=-2.25cm,opacity=1.0] at (current page.east) {\includegraphics[height=2.5cm]{Praat-TextGrid-version-of-the-data-in-Figure-3-300x193.png}};
	\end{tikzpicture}
	\vfill
	\lfr{Imagem: \url{https://traitsai.com/wp-content/uploads/2021/01/Praat-TextGrid-version-of-the-data-in-Figure-3-300x193.png}}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}[fragile=singleslide]
